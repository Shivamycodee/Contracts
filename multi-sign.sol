...
contract MultiSig {
    ...
    function submitTransaction(address payable dest, uint value,bytes memory _data) external {
    ...
    function addTransaction(address payable destination, uint value,bytes memory _data) public returns(uint) {
